...
<head>
    ...
    <title>Sign Up - Hyperscale</title>
...
<body class="bg-black text-white min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md" x-data="{ showPassword: false, showConfirmPassword: false }">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-400 text-sm">Start deploying in seconds</p>
        </div>
        ...
        <div class="bg-gray-900 border border-gray-800 rounded-lg p-8">
            ...
            <form action="{{ route('register.post') }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <button 
                            ...
                            class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-500 hover:text-gray-300 transition-colors">
                            <i class="fas text-sm" :class="showConfirmPassword ? 'fa-eye-slash' : 'fa-eye'"></i>
                        </button>
                    </div>
                </div>
                ...
                <div class="flex items-start">
                    <input 
                        ...
                        id="terms"
                        required
                        class="mt-1 w-4 h-4 bg-black border border-gray-800 rounded focus:ring-0 focus:ring-offset-0 text-white">
            ...
            <div class="relative my-6">
                ...
                <div class="relative flex justify-center text-sm">
                    <span class="px-2 bg-gray-900 text-gray-500">Or sign up with</span>
                </div>
            </div>
