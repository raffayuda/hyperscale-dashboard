...
export const templates: TemplateProject[] = [
    { id: 1, name: 'Next.js Boilerplate', description: 'Get started with Next.js and React in seconds.', icon: '⚛️' },
    { id: 2, name: 'AI Chatbot', description: 'A full-featured, hackable Next.js AI chatbot built by Vercel.', icon: '🤖' },
    { id: 3, name: 'Vite + React Starter', description: 'Vite/React site that can be deployed to Vercel.', icon: '⚡' },
    { id: 4, name: 'Express.js on Vercel', description: 'Simple Express.js + Vercel example that serves html content.', icon: '🚀' }
];
